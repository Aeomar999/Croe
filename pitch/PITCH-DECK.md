...
**[FILL: Name]** · **[FILL: email]** · **[FILL: month year]**
...
**[FILL: 1.5–2.5]% commission** on each released transaction.

- **No commission on refunds.** Buyer made whole → we earn nothing
- Vendor-pays by default; configurable per market

*On a GHS 450 order:* commission ~GHS 9.00 → **net ~GHS 8.00** after disbursement fees
*Break-even:* ~**63 released transactions/month** against target fixed costs

> **Speaker notes:** Flag honestly that aggregator pricing is being confirmed and the model will be updated with real fees. Do **not** present these as settled.
>
> If pushed on how small GHS 8 is: agree, and go straight to the lever — average ticket size. In electronics and sneakers (~GHS 1,200 avg) net per transaction is roughly 3× that. It's the reason for the launch segment on slide 10.
...
**Launch segment:** high-ticket, high-fear categories — **electronics, sneakers, thrift**
Where buyers already refuse to pay first, and where 2% is worth collecting.

**The pitch to a vendor is conversion, not safety:**
> *"You will close the sales you're currently losing."*

> **Speaker notes:** Vendor-led B2B2C is the only acquisition model that works here — buyers will never seek out an escrow app.
>
> The segment choice is deliberate and quantified: a vendor selling low-ticket goods to repeat local customers already has trust and doesn't need us. A vendor closing GHS 1,200 phone sales to strangers loses deals every week to exactly this standoff.

---

## Slide 11 — Traction & Validation Plan

# Pre-launch. Here's what we're proving, and when.

**Now:** product complete and tested · **[FILL: N]** vendors in pilot recruitment · entity formation and licensed-custody arrangement in progress

**60-day pilot measures:**

| Metric | Why it matters |
|---|---|
| Released transactions / month | Demand is real |
| Net margin per transaction | The model holds with real fees |
| Dispute rate + adjudication accuracy | The hard part works |
| Vendor retention at day 60 | Value, not novelty |

> **Speaker notes:** ⚠️ **Be straightforwardly honest here — you are pre-revenue.** Do not dress it up. In fintech, a single invented traction number ends the process at diligence and follows you.
>
> The strength of this slide is that you know exactly what you're testing and why. Most pre-launch founders can't name the four numbers that would prove or kill their business. Say the quiet part: "if dispute rate or adjudication accuracy come back bad, the model doesn't work, and I want to know that in 60 days for [amount] rather than in two years."
>
> Fill in whatever is genuinely true — signed vendor commitment letters are the strongest thing you can put here before launch. Get them.

---

## Slide 12 — The Ask

# **[FILL: amount]** to run a supervised pilot on licensed rails.

| Use of funds | |
|---|---|
| Legal & regulatory setup | Custody structuring, ToS, entity |
| Licensed custody partner onboarding | The P2 milestone |
| Security audit | Penetration test before real money |
| 60-day pilot | **[FILL: N]** vendors, high-ticket segment |

**What this buys:** first real transactions on compliant rails, with measured dispute rate, adjudication accuracy, and vendor retention.

**[FILL: Name]** · **[FILL: email]** · **[FILL: phone]**

> **Speaker notes:** Tie the number to the milestone, never to a runway period. "This gets us to first real transactions on licensed rails with measured unit economics" is fundable. "This gives us nine months" is not.
>
> Have the itemised budget ready if asked — it exists in `GO-TO-MARKET.md` §10.
