# Croe — Implementation Roadmap & Progress (`90-Roadmap.md`)

> The build sequence, mapped to custody phases ([`45-Glossary.md`](45-Glossary.md)). Agents update statuses: `[ ]` todo, `[/]` in-progress, `[x]` done. "No MVP carve-out" means every spec is written; this roadmap sequences the *code*.
...
- [ ] tests written and passing per [`43-Testing-Strategy.md`](43-Testing-Strategy.md) (concurrency, money-precision, fraud where relevant)
- [ ] [`44-Engineering-Rules.md`](44-Engineering-Rules.md) satisfied
...
## Phase 1 — Data & Ledger (spec: [`11`](11-Data-Model.md), [`45`](45-Glossary.md))
...
## Phase 2 — Core API & ACID (spec: [`10`](10-Architecture.md), [`13`](13-Escrow-Lifecycle.md))
...
## Phase 3 — Webhooks & Payments (spec: [`22`](22-Payments-Collection.md), [`23`](23-Payouts-Refunds.md), [`24`](24-Webhooks-and-Idempotency.md))
...
## Phase 4 — Evidence & Heuristics (spec: [`26`](26-Evidence-and-Forensics.md), [`25`](25-Disputes-and-AI-Triage.md))
- [ ] Upload + streaming SHA-256 + object storage; recycled-photo trap.
- [ ] Query A/B/C heuristics + cascading rule engine.

## Phase 5 — AI Triage (spec: [`25`](25-Disputes-and-AI-Triage.md), [`41`](41-Infra-and-Deployment.md))
- [ ] Local LLM (Ollama/vLLM); pin model id → `ai_model_version`.
- [ ] System prompt + strict JSON validation; confidence gate + auto-execution.

## Phase 6 — Identity, KYC, Notifications, Admin (spec: [`20`](20-Identity-Auth.md), [`21`](21-KYC-and-AML.md), [`27`](27-Notifications.md), [`28`](28-Admin-Console.md), [`29`](29-Trust-Score-and-Anti-Fraud.md))
...
## Phase 7 — Frontend (spec: [`31`](31-Frontend-React-Native.md), [`32`](32-Design-System.md), [`30`](30-API-Reference.md))
- [ ] RN app scaffold; Axios forensic interceptor; navigation/state.
- [ ] Core screens; design-system theme; empathetic copy.

## Phase 8 — Ops, Reconciliation, Hardening (spec: [`42`](42-Observability-and-Reconciliation.md), [`43`](43-Testing-Strategy.md), [`40`](40-Security-Threat-Model.md))
...
Spec followed · data contracts + error cases implemented · tests per [`43`](43-Testing-Strategy.md) pass · rules in [`44`](44-Engineering-Rules.md) satisfied · observability wired.
